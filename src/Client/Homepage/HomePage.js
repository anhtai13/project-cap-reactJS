            ...
            <div className="row align-items-center body-content">
                ...
                <section className="s_product_catalog oe_custom_bg o_colored_level o_cc o_cc2 pb0 pt8 mt-5" style={{ backgroundPosition: "50% 0%", backgroundImage: "none" }} data-vcss="001" data-snippet="s_product_catalog" data-name="Pricelist" data-bs-original-title="" title="" aria-describedby="tooltip561251">
                    <div className="container-fluid">
                        ...
                        <section data-snippet="s_dynamic_snippet_products" className="s_dynamic_snippet_products s_dynamic o_colored_level s_product_product_horizontal_card pt0 pb0" data-name="Products" style={{ backgroundImage: "none" }} data-product-category-id="all" data-number-of-records="16" data-filter-id="1" data-template-key="website_sale.dynamic_filter_template_product_product_horizontal_card" data-carousel-interval="7000" data-number-of-elements="3" data-number-of-elements-small-devices="1" data-extra-classes="o_carousel_multiple_rows" data-row-per-slide="3" data-arrow-position="bottom">
                            <div className="container o_not_editable">
                                <div className="dynamic_snippet_template">
                                    <div id="s_dynamic_snippet_2" className="carousel slide" data-bs-interval="7000" data-bs-ride="carousel">
                                        <div className="carousel-inner row w-100 mx-auto" role="listbox">
                                            <div className="carousel-item o_carousel_multiple_rows active" style={{ minHeight: "520.594px" }}>
                                                <div className="row">
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="55" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvs-13-giat-giay-giay-the-thao-sneaker-55#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/55/image_512?unique=1d6df38" alt="Giặt Giày (Giày thể thao -Sneaker)" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt Giày (Giày thể thao -Sneaker)</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static" title="5.0">
                                                                                <i className="fa fa-star" role="img"></i>
                                                                                <i className="fa fa-star" role="img"></i>
                                                                                <i className="fa fa-star" role="img"></i>
                                                                                <i className="fa fa-star" role="img"></i>
                                                                                <i className="fa fa-star" role="img"></i>
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">89.000</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                    ...
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="47" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-14-giat-hap-phu-kien-thoi-trang-option-47#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/47/image_512?unique=72832c3" alt="Giặt hấp phụ kiện thời trang (Option)" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp phụ kiện thời trang (Option)</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static">
                                                                                <i className="fa fa-star-o" role="img"></i>
                                                                                <i className="fa fa-star-o" role="img"></i>
                                                                                <i className="fa fa-star-o" role="img"></i>
                                                                                <i className="fa fa-star-o" role="img"></i>
                                                                                <i className="fa fa-star-o" role="img"></i>
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">35.000</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                                                    <i className="fa fa-fw fa-shopping-cart"></i>
                                                                                </button>
                                                    ...
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="46" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-13-giat-hap-ao-da-thuoc-da-46#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/46/image_512?unique=cb415b0" alt="Giặt hấp áo Da (Thuộc da)" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp áo Da (Thuộc da)</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static">
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">135.000</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                                                    <i className="fa fa-fw fa-shopping-cart"></i>
                                                                                </button>
                                                ...
                                                <div className="row">
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="45" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-12-giat-hap-ao-khoac-phao-45#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/45/image_512?unique=916051f" alt="Giặt hấp áo Khoác Phao" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp áo Khoác Phao</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static">
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">120.000</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                                                    <i className="fa fa-fw fa-shopping-cart"></i>
                                                                                </button>
                                                    ...
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="44" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-11-giat-hap-ao-khoac-mangto-44#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/44/image_512?unique=1e76b88" alt="Giặt hấp áo Khoác (Mangto)" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp áo Khoác (Mangto)</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static">
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">150.000</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                                                    <i className="fa fa-fw fa-shopping-cart"></i>
                                                                                </button>
                                                    ...
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="43" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-10-giat-hap-ao-khoac-jacket-43#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/43/image_512?unique=2c57494" alt="Giặt hấp áo Khoác (Jacket)" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp áo Khoác (Jacket)</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static">
                                                ...
                                                <div className="row">
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="42" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-09-giat-hap-quan-au-42#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/42/image_512?unique=783ec59" alt="Giặt hấp quần Âu" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp quần Âu</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static" title="5.0">
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">45.000</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                                                    <i className="fa fa-fw fa-shopping-cart"></i>
                                                                                </button>
                                                    ...
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="41" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-08-giat-hap-ao-so-mi-41#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/41/image_512?unique=229a026" alt="Giặt hấp áo Sơ Mi" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp áo Sơ Mi</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static" title="5.0">
                                                    ...
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="40" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-07-giat-hap-ao-dai-bo-40#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/40/image_512?unique=0132d36" alt="Giặt hấp áo Dài (Bộ)" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp áo Dài (Bộ)</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static">
                                            ...
                                            <div className="carousel-item o_carousel_multiple_rows" style={{ minHeight: "520.594px" }}>
                                                <div className="row">
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            ...
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-01-giat-hap-ao-vest-39#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/39/image_512?unique=78dc63a" alt="Giặt hấp áo Vest" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp áo Vest</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static" title="4.75">
                                                                                <i className="fa fa-star" role="img"></i>
                                                                                <i className="fa fa-star" role="img"></i>
                                                                                <i className="fa fa-star" role="img"></i>
                                                                                <i className="fa fa-star" role="img"></i>
                                                                                <i className="fa fa-star-half-o" role="img"></i>
                                                                                <small className="text-muted ms-1">
                                                                                    (4)
                                                                                </small>
                                                                            </div>
                                                    ...
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            ...
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-05-giat-hap-chan-vay-38#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/38/image_512?unique=5c182ac" alt="Giặt hấp chân Váy" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp chân Váy</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static">
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">49.000</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                                                    <i className="fa fa-fw fa-shopping-cart"></i>
                                                                                </button>
                                                    ...
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            ...
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-03-giat-hap-am-vay-37#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/37/image_512?unique=e0d8cbc" alt="Giặt hấp Đầm Váy" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp Đầm Váy</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static">
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">75.000</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                                                    <i className="fa fa-fw fa-shopping-cart"></i>
                                                                                </button>
                                                ...
                                                <div className="row">
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="36" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-04-giat-hap-comple-veston-suit-36#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/36/image_512?unique=67ca800" alt="Giặt hấp Comple - Veston (Suit)" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp Comple - Veston (Suit)</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static" title="5.0">
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">140.000</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                                                    <i className="fa fa-fw fa-shopping-cart"></i>
                                                                                </button>
                                                    ...
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="35" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvh-02-giat-hap-ao-cuoi-vay-cuoi-35#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/35/image_512?unique=180c89f" alt="Giặt hấp Áo Cưới (Váy Cưới)" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt hấp Áo Cưới (Váy Cưới)</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static" title="5.0">
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">180.000</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                                                    <i className="fa fa-fw fa-shopping-cart"></i>
                                                                                </button>
                                                    ...
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="34" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dvs-01-giat-say-quan-ao-34#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/34/image_512?unique=20f3eca" alt="Giặt sấy Quần Áo" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt sấy Quần Áo</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static" title="4.86">
                                                                                <i className="fa fa-star" role="img"></i>
                                                                                <i className="fa fa-star" role="img"></i>
                                                                                <i className="fa fa-star" role="img"></i>
                                                                                <i className="fa fa-star" role="img"></i>
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">12.000</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                                                    <i className="fa fa-fw fa-shopping-cart"></i>
                                                                                </button>
                                                ...
                                                <div className="row">
                                                    <div className="d-flex flex-grow-0 flex-shrink-0 col-4">
                                                        <div className="o_carousel_product_card card w-100 border-0 bg-light p-3">
                                                            <input type="hidden" name="product-id" data-product-id="33" />
                                                            <div className="row h-100 p-0">
                                                                <div className="col-lg-4 position-static">
                                                                    <a className="stretched-link o_dynamic_product_hovered" href="/shop/dks-03-giat-khan-tam-khach-san-33#attr=">
                                                                        <img className="img img-fluid mx-auto o_img_product_square" loading="lazy" src="/web/image/product.product/33/image_512?unique=e0feb02" alt="Giặt Khăn Tắm (Khách sạn)" />
                                                                    </a>
                                                                </div>
                                                                <div className="o_carousel_product_card_body col-lg-8 d-flex flex-column justify-content-between">
                                                                    <div>
                                                                        <div className="card-title h6">Giặt Khăn Tắm (Khách sạn)</div>
                                                                    </div>
                                                                    <div>
                                                                        <div className="mb-1">
                                                                            <div className="o_website_rating_static" title="5.0">
                                                                        ...
                                                                        <div className="d-flex align-items-center flex-wrap">
                                                                            <span className="fw-bold" data-oe-type="monetary" data-oe-expression="record_price"><span className="oe_currency_value">13.500</span>&nbsp;₫</span>
                                                                            <div className="o_dynamic_snippet_btn_wrapper ms-auto">
                                                                                <button className="btn btn-primary js_add_cart" title="Thêm vào giỏ hàng">
                                                                                    <i className="fa fa-fw fa-shopping-cart"></i>
                                                                                </button>
                                        ...
                                        <div className="s_dynamic_snippet_arrow_bottom pt-2 d-flex justify-content-center">
                                            <a href="#s_dynamic_snippet_2" className="carousel-control-prev" data-bs-slide="prev" role="button" aria-label="Trước đó" title="Trước đó">
                                                Truoc
                                            </a>
                                            <a href="#s_dynamic_snippet_2" className="carousel-control-next" data-bs-slide="next" role="button" aria-label="Kế tiếp" title="Kế tiếp">
                                                <span className="fa fa-chevron-circle-right fa-2x"></span>
